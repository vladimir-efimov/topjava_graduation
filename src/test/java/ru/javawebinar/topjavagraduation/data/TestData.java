...
public class TestData {
    ...
    private static final Matcher<User> USER_MATCHER = new Matcher<>(List.of("id", "password", "votes"));
    ...
    public static final Menu[] menus = {
            new Menu(1, yestarday, restaurants[0], List.of(dishes[0], dishes[1])),
            new Menu(2, date, restaurants[0], List.of(dishes[0], dishes[1])),
            new Menu(3, date, restaurants[1], List.of(dishes[3], dishes[4])),
    };
    public static final Menu newMenu = new Menu(null, date, restaurants[2], List.of(dishes[5], dishes[6]));
    public static final Menu updatedMenu = new Menu(2, date, restaurants[0], List.of(dishes[0], dishes[1]));
    public static final List<Menu> invalidMenus = List.of(
            new Menu(null, date, restaurants[2], List.of(dishes[0], dishes[6]))
    );
    public static final List<Menu> invalidUpdateMenus = List.of(
            new Menu(2, date, restaurants[2], List.of(dishes[6]))
    );
    private static final Matcher<Menu> MENU_MATCHER =
            new Matcher<>(List.of("id"), List.of("id", "dishes"), List.of("restaurant", "dishes"));
